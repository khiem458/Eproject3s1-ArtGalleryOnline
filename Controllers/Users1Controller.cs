...
namespace ArtGalleryOnline.Controllers
{
    public class Users1Controller : Controller
    {
        ...
        public Users1Controller(ArtgalleryDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("UserId,UserName,UserFullName,UserEmail,UserGender,UserAge,UserPhoneNum,UserAddress,UserPassword,UserRole,RememberMe,IsVerified")] Users users)
        {
